...
- [REQ-PRJ-20260423-05] | 腾讯云 COS 采用 `car-platform-*` 独立前缀并按非生产/生产口径管理密钥 | scope:project | priority:P1 | status:accepted | tags:cos,storage,security,docs,deployment | updated:2026-04-29
