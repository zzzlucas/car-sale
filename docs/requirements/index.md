...
## Active
- [REQ-PRJ-20260426-15] | 客户侧 AI 客服正式接入必须走 backend 代理并先以非流式闭环落地 | scope:project | priority:P1 | status:accepted | tags:ai,customer-support,backend,mobile,siliconflow | updated:2026-04-26
