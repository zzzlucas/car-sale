...
## Active
- [REQ-PRJ-20260422-01] | 当前先以 `mobile + backend + shared-types` 收口的 `monorepo` 结构推进 | scope:project | priority:P0 | status:accepted | tags:monorepo,architecture,frontend,backend,docs | updated:2026-04-23
